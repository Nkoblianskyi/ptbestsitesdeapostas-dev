      ...
      <div className="container mx-auto px-4 max-w-[1150px] py-10 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <Link href="https://www.jogoresponsavel.pt/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center border border-white/10 rounded-sm p-2.5 hover:bg-white/10 transition-colors">
